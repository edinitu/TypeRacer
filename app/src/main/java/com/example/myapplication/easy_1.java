...
public class easy_1 extends AppCompatActivity {
    ...
    private int wpm;
    private double acc;
    private static final int prag = 15;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_easy_1);

        cL = findViewById(R.id.easy1_id);
    ...
    public void nextLv() {
        if(noCorrect >= prag) {
            ...
            reference.child(Utils.player.getUsername()).child("level").setValue("easy_2");
            Utils.player.setLevel("easy_2");
