...
public class hard_1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_hard_1);
        ...
        InputStream in;
        in = getResources().openRawResource(getResources().getIdentifier("hard_lvl1", "raw", getPackageName()));
    ...
    public void nextLv() {
        if(noCorrect >= prag) {
            ...
            reference.child(Utils.player.getUsername()).child("level").setValue("hard_2");
            Utils.player.setLevel("hard_2");
    ...
    // ne intoarce in ecranul hard_scree
