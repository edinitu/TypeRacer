...
public class medium_1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_medium_1);
        ...
        cl = findViewById(R.id.me1);

        // Intructiuni care incarca in vectorul "wordsUsed" cuvintele din fisierul text
        this.wordsUsed = new ArrayList<>();
        InputStream in;
        in = getResources().openRawResource(getResources().getIdentifier("medium_lvl1", "raw", getPackageName()));
    ...
    public void nextLv() {
        if(noCorrect >= prag) {
            ...
            reference.child(Utils.player.getUsername()).child("level").setValue("medium_2");
            Utils.player.setLevel("medium_2");
            startActivity(intent);
