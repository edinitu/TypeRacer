...
public class medium_3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_medium_3);
        ...
        cl = findViewById(R.id.me3);

        // Intructiuni care incarca in vectorul "wordsUsed" cuvintele din fisierul text
        this.wordsUsed = new ArrayList<>();
        InputStream in;
        in = getResources().openRawResource(getResources().getIdentifier("medium_lvl3", "raw", getPackageName()));
    ...
    public void nextLv() {
        if(noCorrect >= prag) {
            ...
            reference.child(Utils.player.getUsername()).child("level").setValue("hard_1");
            Utils.player.setLevel("hard_1");
