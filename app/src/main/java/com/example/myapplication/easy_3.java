...
public class easy_3 extends AppCompatActivity {
    ...
    private int wpm;
    private double acc;
    private static final int prag = 7;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_easy_3);
    ...
    public void nextLv() {
        if(noCorrect >= prag) {
            ...
            reference.child(Utils.player.getUsername()).child("level").setValue("medium_1");
            Utils.player.setLevel("medium_1");
            startActivity(intent);
